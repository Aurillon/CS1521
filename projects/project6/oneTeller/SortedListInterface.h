...
/** @class SortedListInterface SortedListInterface.h
...
class SortedListInterface {
  public:
   ...
   /** Gets the position of the first or only occurrance of the given
           *  entry in this sorted list. In the case the entry is not
   in this
   *  sorted list, it determines the position where the entry should
           *  be located if it were in this sorted list.
                                      ...
                                      *  @post None.
                                      *
                                      *  @param anEntry The entry to
                                      *  locate.
                                      *
                                      *  @return Either the position
                                      *  of the first or only
                                      *  occurrance of
                                      *          the given entry if
                                      *  its is in this sorted list,
                                      *  or the
                                                    *
                                      *  position where the entry
                                      *  would occur, but as a
                                      *  negative
                                                    *
                                      *  integer. */
